...
class BaseActionFlowView: UIView {
    ...
    private var pageControl: UIPageControl = {
        ...
        pageControl.tintColor = UIColor.exLightGray()
    ...
    let actionUnhappyBtn = BaseButton(title: OnboardingLocalization.skip.text,
                                      type: .shadow)
    
    let actionHappyBtn = BaseButton(title: OnboardingLocalization.enable.text,
                                    type: .shinningBlue)
    ...
    private func setScrollView() {
        scrollView.snp.makeConstraints { make in
            ...
            make.bottom.equalTo(actionUnhappyBtn).offset(-10).priority(.high)
        }
    ...
    private func setActionUnhappyBtn() {
        ...
        actionUnhappyBtn.snp.makeConstraints { make in
            make.left.equalTo(self).offset(24).priority(.high)
...
extension BaseActionFlowView: UIScrollViewDelegate {
